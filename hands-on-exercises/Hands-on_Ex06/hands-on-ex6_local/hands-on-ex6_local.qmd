...
Next, we will set a statistical significance level for the local Moran. (p-value)
...
### **10.1 Deriving distance-based weight matrix**
...
### **10.1.2 Determining Cutoff Distance**
...
### **10.1.3 Computing fixed distance weight matrix**
...
### **10.2 Computing adaptive distance weight matrix**
...
[**The Gi statistics is represented as a Z-score. Greater values represent a greater intensity of clustering and the direction (positive or negative) indicates high or low clusters.**]{.underline}
